...
M.lf = build_scratchpad("kitty -o background_opacity=1.0 --class files -e lf", {instance = "files"});
M.lf:turn_off()

M.dotfiles = build_scratchpad("kitty -o background_opacity=1.0 --class dots -e hx ~/Code/dotfiles", {instance = "dots"})
M.dotfiles:turn_off()

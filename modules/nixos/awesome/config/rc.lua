...
local function switch_keyboard_layout()
  awful.spawn("switch_keyboard_layout")
end
...
-- awful.key({ super, }, "s", hotkeys_popup.show_help),
  ...
  awful.key({}, "XF86AudioRaiseVolume", function() volume:raise() end),
  awful.key({ super }, "XF86AudioMute", function() awful.spawn("pavucontrol") end),
  awful.key({ super }, "F12", function() awful.spawn("pavucontrol") end),
  ...
  awful.key({ super }, "Tab", function() awful.spawn("rofi -window-match-fields name -show window") end),
  ...
  awful.key({ super, alt }, "l", function() awful.spawn("betterlockscreen -l") end),
  awful.key({ super, "Shift" }, "b", function() awful.spawn("rofi-bluetooth") end),
  awful.key({ super }, "b", function() awful.spawn("google-chrome-stable") end),

    ...
    text = (
      ...
      ''
        ...
        local global_keys = gears.table.join(
          ...
          awful.key({ modkey }, "d", function() awful.spawn("${pkgs.dmenu}/bin/dmenu_run"); end),
          awful.key({ modkey, "Mod1" }, "l", function() awful.spawn("${config.home-manager.users.cabero.services.betterlockscreen.package}/bin/betterlockscreen -l dim &"); end),
          awful.key({ modkey }, "b", function() awful.spawn("${config.home-manager.users.cabero.programs.firefox.package}/bin/firefox"); end),
          awful.key({ modkey }, "t", function() awful.spawn("${pkgs.todoist-electron}/bin/todoist-electron"); end),

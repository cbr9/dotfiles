...
with lib; {
  services.betterlockscreen = {
    enable = nixosConfig != {};
    package = pkgs.betterlockscreen.override {withDunst = !config.xsession.windowManager.awesome.enable;};
    inactiveInterval = 5;
  };

  xdg.configFile."betterlockscreenrc" = mkIf config.services.betterlockscreen.enable {
    text = ''
  ...
  services.caffeine.enable = nixosConfig != {};
}

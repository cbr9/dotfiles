{
  ...
  xdg.configFile = {
    ...
    "awesome/rc.lua".text = with lib;
      mkIf config.xsession.windowManager.awesome.enable # lua
      
      ''
        #!/usr/bin/env nix-shell -p pulseaudio
        ...
        globalkeys = gears.table.join(
          ...
          awful.key({ modkey, "Mod1" }, "l", function() awful.spawn("${config.services.betterlockscreen.package}/bin/betterlockscreen -l dim &"); end),

{
  ...
  xdg.configFile."awesome/rc.lua".text = with lib;
    mkIf config.xsession.windowManager.awesome.enable # lua
    ...
    ''
      ...
      local function set_wallpaper(s)
        ...
        if beautiful.wallpaper then
          ...
          awful.spawn("${config.services.betterlockscreen.package}/bin/betterlockscreen -u ${config.stylix.image}")
        end
      end
      ...
      globalkeys = gears.table.join(
        ...
        -- Lockscreen
        awful.key({modkey, "Mod1"}, "l", function() awful.spawn.easy_async_with_shell("${config.services.betterlockscreen.package}/bin/betterlockscreen -l dim &"); end,

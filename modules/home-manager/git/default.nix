...
with lib; {
  ...
  programs.git = {
    ...
    extraConfig = {
      ...
      gpg.format = "ssh";
      gpg."ssh".program = lib.mkIf (nixosConfig != {} && nixosConfig.programs._1password-gui.enable && nixosConfig.programs._1password-gui.sshAgent) "${nixosConfig.programs._1password-gui.package}/bin/op-ssh-sign";
      commit.gpgsign = true;
